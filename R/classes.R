...
setMethod("plot", signature(x = "ACSPlan"),
      function(x, xl=0.001, xu=0.1, xlabm="p",ylabm="L(p)",typem="l",...) {p=seq(from=xl,to=xu,length.out=1000);plot(x=p,y=OC(p,n(x),k(x), type="t"),  xlab=xlabm,ylab=ylabm,type=typem, ...)     })
